			...
			*/
			...
			@Test
			  public void Studentname_contains_Special_Characters() throws InterruptedException
			  {
				  ...
				  driver.findElement(By.xpath("//*[@id=\"4\"]/li/a")).click();
				  Thread.sleep(1500);
				  driver.findElement(By.name("new-admission")).click();
				  driver.findElement(By.name("FirstName")).sendKeys("#$#^%&^&*(");
				  boolean studentname =driver.findElement(By.name("FirstName")).getAttribute("value").matches(studentname_pattern);
				  Assert.assertTrue(studentname, "Student Name Contains Special Characters");
			 ...
			 @Test
				...
				//Primary Mobile No
					...
					//Admission Date
					@Test
					public void Todays_Admission_Date()
					{
						Date date = new Date();
						String date1= new SimpleDateFormat("yyyy-MM-dd").format(date);
						String actual = driver.findElement(By.id("txtCreatedDate")).getAttribute("value");
						Assert.assertEquals(actual, date1, "Admission NOT having Today's Date");
					}
