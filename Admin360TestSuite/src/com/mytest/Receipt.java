...
import org.testng.annotations.Test;
	...
	public class Receipt extends Login
	{
		...
		public void Save_Changes_Button_Functionality() throws InterruptedException
		{
			...
			Assert.assertEquals(actualaccount, "Java Seminar", "Account NOT Getting Saved");
		...
		public void Cheque_Payment_Mode() throws InterruptedException
		{
			driver.findElement(By.xpath("//*[@id=\"nav-state-toggle\"]/i")).click();
			Thread.sleep(1500);
			driver.findElement(By.xpath("//*[@id=\"sidebar\"]/div/div[1]/ul[1]/li[7]/a")).click();
