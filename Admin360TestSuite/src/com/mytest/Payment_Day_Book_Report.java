...
import org.testng.annotations.Test;
	...
	public class Payment_Day_Book_Report extends Login
	{
		@Test
		...
		public void Cash_Payment_Mode() throws InterruptedException
		{
			...
			Assert.assertEquals(actualtransactiontype, "Debit", "Transaction Type NOT Getting Saved");
			Assert.assertEquals(actualtransactionfrom, "Payment Voucher", "Transaction From NOT Getting Saved");
		...
		public void Cheque_Payment_Mode() throws InterruptedException
		{
			...
			Thread.sleep(1000);
			String voucherno = driver.findElement(By.xpath("//*[@id=\"view-payment-voucher\"]/tbody/tr/td[1]")).getText();
			...
			Assert.assertEquals(actualtype, "Debit", "Cheque Type NOT Getting Saved");
			...
			Assert.assertEquals(actualtransactiontype, "Debit", "Transaction Type NOT Getting Saved");
			Assert.assertEquals(actualtransactionfrom, "Payment Voucher", "Transaction From NOT Getting Saved");
			Assert.assertEquals(actualtransactionnote, "Cheque cleared against payment voucher no. "+voucherno, "Transaction Note NOT Getting Saved");
			Assert.assertEquals(actualdaybookamount, "500", "Transaction Amount NOT Getting Saved");
		}
